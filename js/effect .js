...
onClick: function(e) {
    ...
    effect.setAttribute('particle-system', 'preset: defolt; texture: ./images/redheart.png;color: #ff0, #ff9;maxParticleCount: 100;maxAge: ' + (particleAge / 1000) + ';velocityValue:0 -1 0; accelerationValue: 0 0.5 0; duration: 1;');
    return effect;
    };
